...
import com.codingwithmitch.openapi.util.ErrorHandling.ErrorHandling.Companion.ERROR_UNKNOWN
...
constructor(
    ...
    override fun searchBlogPosts(
        ...
        return object : NetworkBoundResource<BlogListSearchResponse, List<BlogPost>, BlogViewState>(
            ...
            stateEvent = stateEvent,
            apiCall = {
                apiDashboardService.searchListBlogPosts(
    ...
    override fun isAuthorOfBlogPost(
        ...
        val apiResult = safeApiCall(IO) {
            apiDashboardService.isAuthorOfBlogPost(
                "Token ${authToken.token!!}",
                slug
            )
        }
    ...
    override fun deleteBlogPost(
        ...
        val apiResult = safeApiCall(IO) {
            apiDashboardService.deleteBlogPost(
                "Token ${authToken.token!!}",
                blogPost.slug
            )
        }
    ...
    override fun updateBlogPost(
        ...
        val apiResult = safeApiCall(IO) {
            apiDashboardService.updateBlog(
                "Token ${authToken.token!!}",
                slug,
                title,
                body,
