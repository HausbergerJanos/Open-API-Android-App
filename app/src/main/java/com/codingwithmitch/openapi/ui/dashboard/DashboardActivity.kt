...
class DashboardActivity : BaseActivity(),
    ...
    override fun inject() {
        (application as BaseApplication).dashboardComponent()
            .inject(this)
    }
    ...
    private fun restoreSession(savedInstanceState: Bundle?) {
        savedInstanceState?.get(AUTH_TOKEN_BUNDLE_KEY)?.let { authToken ->
            sessionManager.setToken(authToken as AuthToken)
        }
    }
    ...
    private fun navAuthActivity() {
        ...
        finish()
        (application as BaseApplication).releaseDashboardComponent()
    }
